...
class PossederController extends HttpController
{
    ...
    {
        if($this->data['function'] == 'createPosseder') {
            if(isset($this->data['idListe1']) && isset($this->data['idListe2'])) {
                $d = $this->repository->createPosseder($this->data['idListe1'], $this->data['idListe2']);
            }
            else
