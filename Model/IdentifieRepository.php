...
class IdentifieRepository extends Repository
{
    ...
    public function updateIdentifie($element_idElements, $etiquette_idEtiquette) {
        try {
            ...
            $stmt->bindParam(':element_idElements', $element_idElements);
            $stmt->bindParam(':etiquette_idEtiquette', $etiquette_idEtiquette);
            $stmt->bindParam(':element_idElements2', $element_idElements);
            $stmt->bindParam(':etiquette_idEtiquette2', $etiquette_idEtiquette);
            $stmt->execute();
